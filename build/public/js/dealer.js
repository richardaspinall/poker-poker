...
function dealCards(seatNumber, holeCards, playerSeatNumbers) {
    return __awaiter(this, void 0, void 0, function () {
        var i, cardValue, card, i, cardValue, card;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(i < playerSeatNumbers.length)) return [3 /*break*/, 4];
                    if (seatNumber == playerSeatNumbers[i]) {
                        cardValue = holeCards.card1;
                        card = new Image();
                ...
                case 4:
                    ...
                    _a.label = 5;
                case 5:
                    if (!(i < playerSeatNumbers.length)) return [3 /*break*/, 8];
                    if (seatNumber == playerSeatNumbers[i]) {
                        cardValue = holeCards.card2;
                        card = new Image();
                        card.src = "images/cards/" + cardValue + ".svg";
                        // Show player cards
